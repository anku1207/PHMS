...
class _CaseHistoryTabState extends State<CaseHistoryTab> with SingleTickerProviderStateMixin {
              ...
              return Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Date: ${appointment.appointmentdatetime}',style:Theme.of(context).textTheme.bodyText1?.copyWith(fontSize: 16)),
                      SizedBox(height: 4),
                      Text(
                      ...
                      SizedBox(height: 4),
                      Text('Hospital Name: ${appointment.reason}',style:Theme.of(context).textTheme.bodyText2),
                      SizedBox(height: 4),
                      Text('Address: ${appointment.reason}',style:Theme.of(context).textTheme.bodyText2),
                      SizedBox(height: 16),
                      Align(
