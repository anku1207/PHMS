...
class _DoctorListState extends State<DoctorList> {
  ...
  void initState() {
    ...
    Doctorlist doctorlist = Doctorlist(doctorName: "Dr. John Doe",hospital: "Tantia Hospital",
        address: "P68, D2-block, Midc., Chinchwad",city: "Pune",
        country: "India",phoneNumber: "27475929",state: "Maharashtra",specialty: "Cardiology",
    time: "12.00",zipCode: "411019");
    doctorsList.add(doctorlist);
    doctorlist = Doctorlist(doctorName: "Dr. John Doe",hospital: "Tantia Hospital",
        address: "P68, D2-block, Midc., Chinchwad",city: "Pune",
        country: "India",phoneNumber: "27475929",state: "Maharashtra",specialty: "Cardiology",
        time: "12.00",zipCode: "411019");
    doctorsList.add(doctorlist);
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text('Country: ${doctor.country}',style:Theme.of(context).textTheme.bodyText2),
                          SizedBox(height: 4),
