...
class PatientCaseRegisterScreen_1 extends StatefulWidget {
  late final Object argument;

  PatientCaseRegisterScreen_1({required this.argument});

  @override
  State<PatientCaseRegisterScreen_1> createState() =>
      _PatientCaseRegisterScreen_1State();
}

class _PatientCaseRegisterScreen_1State
    extends State<PatientCaseRegisterScreen_1> {
  ...
  void getPatientByMobile(BuildContext context, String mobileNumber) {
    ...
    getPatientByMobileResponse.catchError(
      ...
      if (value != null) {
        if (value.success == "1") {
          Navigator.pushNamed(context, UavRoutes.Patient_case_register_screen_2,
