...
const UavPrimaryColor =  Color(0xff689f38); //Color(0xFF425A8B);
const UavSecondaryColor = Color(0xff689f38);
const UavTextColor = Color(0xff689f38);



// AppBar color
const AppBar_Color=  Color(0xff689f38);
const AppBar_Icon_Color= Colors.white;
const AppBar_Text_Color=  Colors.white;
const Select_Icon_Color=  Color(0xF77BBBE5);


//Activity color
const Activity_Icon_Color_White = Colors.white;
const Activity_ALL_Text_Color = Color(0xff689f38);

const Activity_EditText_Border_Color =  Colors.black;
const Activity_EditText_Hint_Color = Colors.black;
const Activity_EditText_Label_Text_Color =  Colors.black;
const Activity_EditText_Prefix_Icon_Color =  Colors.black;
const Activity_Cursor_Color =  Colors.black;
...
const Activity_Button_BG_Color= Color(0xff689f38);
const Activity_Button_Border_Color = Color(0xff689f38);
...
const Activity_Bottom_Nav_Color =Color(0xff689f38);
...
const actions_bg_orange =Color(0xff689f38);
