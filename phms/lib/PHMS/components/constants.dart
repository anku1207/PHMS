...
const UavPrimaryColor =  Color(0xFF425A8B); //Color(0xFFFF7643);
const UavSecondaryColor = Color(0xFF425A8B);
const UavTextColor = Color(0xFF425A8B);



// AppBar color
const AppBar_Color=  Color(0xFF425A8B);
...
const Activity_ALL_Text_Color = Color(0xFF425A8B);

const Activity_EditText_Border_Color = Color(0xFF425A8B);
const Activity_EditText_Hint_Color = Color(0xFF425A8B);
const Activity_EditText_Label_Text_Color = Color(0xFF425A8B);
const Activity_EditText_Prefix_Icon_Color = Color(0xFF425A8B);
const Activity_Cursor_Color = Color(0xFF425A8B);




const Activity_Text_Color_White = Colors.white;


const Activity_Tab_Select_Color = Color(0x37018ad0);
...
const Activity_Button_BG_Color= Color(0xFF425A8B);
const Activity_Button_Border_Color = Color(0xFF425A8B);
const Activity_Button_Text_Color =Colors.white;



const Activity_Dialog_Title_Color =Colors.grey;
const Activity_Dialog_Message_Color =Colors.grey;

const Activity_Container_Border_Color_White =Colors.white;
const Activity_Bottom_Nav_Color =Color(0xFF425A8B);
